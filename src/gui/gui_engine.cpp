...
bool GuiEngine::init(GLFWwindow *_window, MainEngine *_mainEngine)
{
    window = _window;
...
void GuiEngine::run()
{
    ...
    // Game Engine
    menuBar.ShowMenuBar(mainEngine, showDetail, showView, showHierarchy, showPreferences);

    ImGui::PushFont(icons);
    secondMenuBar.ShowSecondaryMenuBar(mainEngine);
    ImGui::PopFont();
